...
public class SchedulerTestCasesForUpdate implements TestTemplateInvocationContextProvider {
        ...
        public Stream<TestTemplateInvocationContext> provideTestTemplateInvocationContexts(ExtensionContext context) {
                ...
                ScheMReqDto testData_order2 = new ScheMReqDto(
                                ...
                                "0 0 10 * * ?",
                                "Y");
                ResponseApi<?> expected_order2 = ResponseApi.fail(ErrorCode.VALIDATION_ERROR_CLIENT, "스케줄명 필수입니다.");
                ...
                ResponseApi<?> expected_order6 = ResponseApi.fail(ErrorCode.VALIDATION_ERROR_CLIENT, "클래스명은 필수입니다.");
                ...
                ResponseApi<?> expected_order4 = ResponseApi.success(Map.of("data", new ScheMResDto(
                                "sche-002_test", // 기존 활성 스케줄러
                                "메일 발송 (비활성화)",
                                "메일 발송 스케줄러 비활성화",
                                "MAIL_GROUP",
                ...
                ScheMReqDto testData_order7 = new ScheMReqDto(
                                ...
                                "INVALID_CRON_FORMAT", // 잘못된 Cron 표현식
                                "Y");
                ResponseApi<?> expected_order7 = ResponseApi.fail(ErrorCode.PAGE_NOT_FOUND);
                ...
                List<TestCaseDetail> testCases = List.of(
                                new TestCaseDetail<>(url_order1, testName_order1, testData_order1, expected_order1,
                                                status_order1),
                                new TestCaseDetail<>(url_order2, testName_order2, testData_order2, expected_order2,
                                                status_order2),
                                new TestCaseDetail<>(url_order6, testName_order6, testData_order6, expected_order6,
                                                status_order6),
                                new TestCaseDetail<>(url_order3, testName_order3, testData_order3, expected_order3,
                                                status_order3),
                                new TestCaseDetail<>(url_order4, testName_order4, testData_order4, expected_order4,
                                                status_order4),
                                new TestCaseDetail<>(url_order5, testName_order5, testData_order5, expected_order5,
                                                status_order5),
                                new TestCaseDetail<>(url_order7, testName_order7, testData_order7, expected_order7,
                                                status_order7));
