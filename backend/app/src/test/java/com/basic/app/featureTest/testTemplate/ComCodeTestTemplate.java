...
@Transactional
@Sql(scripts = {
                "classpath:sql/test-data/comcode-m-data.sql",
                "classpath:sql/test-data/comcode-t-data.sql",
                "classpath:sql/test-data/comcode-d-data.sql"
}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_CLASS)
@Sql(scripts = "classpath:sql/test-data/cleanup-test-data.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_CLASS)
