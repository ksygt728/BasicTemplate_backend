...
public class TbComCodeDPivot extends TableImpl<TbComCodeDPivotRecord> {
     ...
     */
    public final TableField<TbComCodeDPivotRecord, LocalDateTime> CREATE_DATE = createField(DSL.name("CREATE_DATE"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
     ...
     */
    public final TableField<TbComCodeDPivotRecord, LocalDateTime> TIMESTAMP = createField(DSL.name("TIMESTAMP"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
