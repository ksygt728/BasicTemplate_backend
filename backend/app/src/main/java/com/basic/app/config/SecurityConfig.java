...
// import com..app.jwt.JwtAthorizationFilter;
...
// .authorizeRequests()
// .antMatchers("/user/**")
// .access("hasRole('ROLE_HOST') or hasRole('ROLE_GUEST') or
...
// .antMatchers("/host/**")
// .access("hasRole('ROLE_HOST') or hasRole('ROLE_MANAGER') or
// hasRole('ROLE_ADMIN')")
// .antMatchers("/guest/**")
// .access("hasRole('ROLE_GUEST') or hasRole('ROLE_MANAGER') or
// hasRole('ROLE_ADMIN')")
...
// web.ignoring()
// .antMatchers("/favicon.ico", "/error", "/swagger-ui/**",
