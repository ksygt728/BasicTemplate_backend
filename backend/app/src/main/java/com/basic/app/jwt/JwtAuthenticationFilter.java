...
// //스프링 시큐리티에서 UsernamePasswordAuthenticationFilter(로그인을 수행할때 실행되는 filter)를
// 상속받아 JwtAuthenticationFilter를 사용
...
// log.info("[TRY LOGIN] --- [CLASS] UsernamePasswordAuthenticationFilter ---
...
// UsernamePasswordAuthenticationToken(user.getID(),
// user.getPassword());
...
// return authentication; /* authentication객체를 session 영역에 저장하는 방법(권한처리를 위해)이
// return하는 것 */
// } catch (IOException e) {
// e.printStackTrace();
// }
