 ...
 * 
 *      kakao : http://[baseURL]:8080/oauth2/authorization/kakao
 *      google : http://[baseURL]:8080/oauth2/authorization/google
 *      naver : http://[baseURL]:8080/oauth2/authorization/naver
 * @Step :
 * 
 *       [OAuth2 로그인 절차]
...
public class CustomOAuth2SuccessHandler implements AuthenticationSuccessHandler {
        ...
        public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
                ...
                redisTemplate.opsForValue().set(
                                ...
                                jwtProperties.getExpireTime().getRefreshToken().toMillis(), TimeUnit.MILLISECONDS) // 만료시간
                                                                                                                   // 설정(자동삭제)
                ;
