...
public class TbChaebun extends TableImpl<TbChaebunRecord> {
     ...
     */
    public final TableField<TbChaebunRecord, LocalDateTime> CREATE_DATE = createField(DSL.name("CREATE_DATE"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
     ...
     */
    public final TableField<TbChaebunRecord, LocalDateTime> TIMESTAMP = createField(DSL.name("TIMESTAMP"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
