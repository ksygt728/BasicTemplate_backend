...
public class AdminMenuController {
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<Map<String, Object>>> insertMenuForAdmin(Menu menu) {
  ...
  @PutMapping
  public ResponseEntity<ApiResponse<Map<String, Object>>> updateMenuForAdmin(Menu menu) {
